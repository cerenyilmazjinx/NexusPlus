...
#[derive(Debug)]
pub struct NexusPlusProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NexusPlusProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NexusPlus processing");
    
    let mut processor = NexusPlusProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NexusPlusProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NexusPlusProcessor::new(false);
